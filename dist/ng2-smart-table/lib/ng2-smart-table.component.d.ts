...
export declare class Ng2SmartTableComponent implements OnChanges {
    ...
    static ɵfac: i0.ɵɵFactoryDef<Ng2SmartTableComponent>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<Ng2SmartTableComponent, "ng2-smart-table", never, { "source": "source"; "settings": "settings"; }, { "rowSelect": "rowSelect"; "userRowSelect": "userRowSelect"; "delete": "delete"; "edit": "edit"; "create": "create"; "custom": "custom"; "deleteConfirm": "deleteConfirm"; "editConfirm": "editConfirm"; "createConfirm": "createConfirm"; "rowHover": "rowHover"; }, never>;
}
