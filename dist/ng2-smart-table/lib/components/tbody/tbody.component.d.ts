...
export declare class Ng2SmartTableTbodyComponent {
    ...
    ngOnChanges(): void;
    static ɵfac: i0.ɵɵFactoryDef<Ng2SmartTableTbodyComponent>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<Ng2SmartTableTbodyComponent, "[ng2-st-tbody]", never, { "grid": "grid"; "source": "source"; "deleteConfirm": "deleteConfirm"; "editConfirm": "editConfirm"; "rowClassFunction": "rowClassFunction"; }, { "save": "save"; "cancel": "cancel"; "edit": "edit"; "delete": "delete"; "custom": "custom"; "edited": "edited"; "userSelectRow": "userSelectRow"; "editRowSelect": "editRowSelect"; "multipleSelectRow": "multipleSelectRow"; "rowHover": "rowHover"; }, never>;
}
